...
In this final unit, we are going to look at the math of "Irrationality." We will study the "Limit of Arbitrage"—the terrifying reality that you can be 100% mathematically correct that a bubble exists, but if the crowd stays crazy for longer than you have money, you will still go bankrupt. We are going to learn that the ultimate investor needs two things: a calculator to find the truth, and the emotional discipline to survive the crowd. We will move beyond the clean lines of the "Slow Market" and enter the messy, human, and often profitable world of the "Fast Market." This is where the laboratory of math meets the laboratory of the human soul. By understanding our own biases, we can learn to use the math as a compass even when the world around us has lost its way.`,
  fullText: [
    '<span className="text-indigo-600 font-bold">The Hook: The Crowd vs. The Calculator</span>\nImagine you live in a town where every morning, everyone gathers in the square to vote on what a single loaf of bread is worth. Usually, the townspeople are reasonable, checking the price of wheat and flour. But one morning, a rumor spreads that bread causes eternal youth. Suddenly, people are trading their houses for a sourdough boule. The math of wheat hasn\'t changed — but the "Price" has entered a galaxy of its own. This is Behavioral Finance.',
    '1. <span className="text-indigo-600 font-bold">The Central Tension</span>\nClassical finance assumes that prices are set by individuals methodically doing the math—discounting cash flows and weighing risk. The uncomfortable truth is that prices are set by whoever shows up to trade that day. On many days, the marginal buyer is not running a math model; they are chasing a trend, panicking out of a loss, or buying simply because their neighbors are.',
    '<span className="text-indigo-600 font-bold">The Two Market Clocks:</span>\n- <span className="text-indigo-600 font-bold">The Slow Market</span>: Governed by cash flows and math. <span className="text-indigo-600 font-bold">It always wins eventually.</span>\n- <span className="text-indigo-600 font-bold">The Fast Market</span>: Driven by momentum and fear. <span className="text-indigo-600 font-bold">It usually wins today.</span>',
    '2. <span className="text-indigo-600 font-bold">Momentum: The Anomaly That Refuses to Die</span>\nThe "Random Walk" model says yesterday\'s price move tells you nothing about tomorrow. But in the real world, <span className="text-indigo-600 font-bold">Momentum</span> is real. Stocks that have been going up tend to keep going up. Why? Because information doesn\'t hit a market like a lightning bolt; it seeps in like a leak. By the time the "Rational" crowd has finished their math, the "Impatience" crowd has already started a trend.',
    '3. <span className="text-indigo-600 font-bold">Prospect Theory: Why Losses Hurt Twice as Much</span>\nPsychologists have proven that losing \\$100 feels twice as "painful" as winning \\$100 feels "good." This single fact destroys rational portfolios:\n- <span className="text-indigo-600 font-bold">The Disposition Effect</span>: We sell our "winners" too early (to lock in the good feeling) and hold our "losers" too long (to avoid the pain of admitting defeat).\n- <span className="text-indigo-600 font-bold">The Lottery Preference</span>: We overpay for tiny chances at massive payouts (Penny stocks, out-of-the-money options).',
    '4. <span className="text-indigo-600 font-bold">Herding and Information Cascades</span>\nHerding isn\'t always "stupid." If you see 100 people running out of a building, you don\'t stop to calculate the structural integrity of the walls — you run too! In markets, when everyone starts selling, it creates a <span className="text-indigo-600 font-bold">Cascade</span>. Your own private research might say the stock is 100% fine, but the "Social Signal" of a crash is so loud it drowns out your data.',
    '5. <span className="text-indigo-600 font-bold">Bubbles and the "Greater Fool" Theory</span>\nA bubble occurs when we stop asking "What is this worth?" and start asking "What will the next person pay me for it?" \n- <span className="text-indigo-600 font-bold">The Feedack Loop</span>: Rising prices $\\rightarrow$ Media Attention $\\rightarrow$ New Buyers $\\rightarrow$ Rising Prices.\n- <span className="text-indigo-600 font-bold">The Limit of Arbitrage</span>: You might <span className="italic">know</span> a bubble is irrational, but as the saying goes: <span className="italic">"The market can stay irrational longer than you can stay solvent."</span> Shorting a bubble is mathematically correct but financially suicidal if the crowd stays crazy for one month longer than you have money.',
    '6. <span className="text-indigo-600 font-bold">Synthesis: Humility vs. Calculation</span>\nThe goal of this lab isn\'t to tell you the math is "wrong." It\'s to show you that the math tells you where prices <span className="italic">should</span> be, while behavior tells you where they <span className="italic">will</span> be on the way. The complete investor needs both: the calculator to find reality, and the discipline to survive the crowd.'
  ],
  quizzes: [
    {
      id: 'b1',
