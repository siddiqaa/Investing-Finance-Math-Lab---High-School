...
export const newsBridge: LessonContent = {
  ...
  introduction: `In Unit 4, we mastered the <span className="text-indigo-600 font-bold">Gordon Growth Model</span> ($P_0 = \\frac{D_1}{r - g}$). It felt clean, elegant, and perfectly solid. If you type in the numbers, you get a single, perfect "fair value" price. 

But if you look at a real-world stock ticker, the price is constantly flickering and jumping. It doesn't sit still. Why?

The secret is that a stock's price is not a historical record; it is a <span className="text-indigo-600 font-bold">prediction of the future</span> made by thousands of buyers and sellers. When you calculate a stock's price, you are choosing a growth rate $g$ and a discount rate $r$ based on what you <span className="italic">expect</span> to happen.
...
In this bridge unit, we will see how <span className="text-indigo-600 font-bold">unpredictable news</span> forces investors to instantly re-calculate their formulas, turning smooth mathematical equations into the jagged, wiggling price paths we see in the real world.`,
  fullText: [
    '<span className="text-indigo-600 font-bold">1. Price as Current Collective Expectations</span>\nAt any given second, a stock\'s price reflects all the information that is currently public. The buyers and sellers in the market have already done the math, and they have agreed on a price based on their current estimates of the company\'s growth rate ($g$) and risk ($r$).\n\nBecause of this, <span className="text-indigo-600 font-bold">expected news does not change the price</span>. If everyone already expects a company to grow at $4\\%$ per year, and the company announces, "We grew by $4\\%$," the stock price will barely move. The expectation was already "priced in"!',
    '2. <span className="text-indigo-600 font-bold">The "Surprise" Factor (Delta g and Delta r)</span>\nOnly <span className="text-indigo-600 font-bold">unexpected information (news)</span> changes stock prices. When new information arrives, it changes our GGM inputs. Let\'s see the math of a news shock:\n\nSuppose a company has a dividend $D_1 = \\$2$, a discount rate $r = 8\\%$, and an expected growth rate $g = 3\\%$.\n- <span className="text-indigo-600 font-bold">Before News:</span>\n$P_{\\text{old}} = \\frac{\\$2}{0.08 - 0.03} = \\frac{\\$2}{0.05} = \\$40$\n\nSuddenly, news hits that the company\'s main product is selling twice as fast as expected. Investors revise their growth expectations upward to $g = 5\\%$ ($0.05$):\n- <span className="text-indigo-600 font-bold">After News:</span>\n$P_{\\text{new}} = \\frac{\\$2}{0.08 - 0.05} = \\frac{\\$2}{0.03} \\approx \\$66.67$\n\nThe stock price jumps instantly from \\$40 to \\$66.67! This instantaneous jump is called <span className="text-indigo-600 font-bold">Price Discovery</span>.',
    'KNOWLEDGE_CHECK_NEWS_BRIDGE',
    '3. <span className="text-indigo-600 font-bold">Why Price Charts Look Random</span>\nThink about this logically:\n- If stock prices only change when <span className="text-indigo-600 font-bold">unexpected news</span> arrives,\n- And news, by definition, is <span className="text-indigo-600 font-bold">unpredictable</span> (otherwise it wouldn\'t be a surprise),\n- Then stock price changes <span className="italic">must</span> also be unpredictable and random!\n\nThis is the philosophical bridge to Unit 6. Individual jumps are caused by logical, mathematical adjustments to news. But because news events occur randomly over time, when you zoom out, the series of continuous price jumps forms a jagged, random walk that looks like a chaotic wiggle. You are watching a deterministic formula adjust to a stochastic world!',
    '<span className="text-indigo-600 font-bold">Summary Check — The Three Golden Rules of Price Discovery:</span>\n- <span className="text-indigo-600 font-bold">Rule 1:</span> Prices reflect collective predictions about the future.\n- <span className="text-indigo-600 font-bold">Rule 2:</span> Only surprise news shifts the inputs ($g$ or $r$) of our valuation formulas.\n- <span className="text-indigo-600 font-bold">Rule 3:</span> Unpredictable news creates unpredictable price movements, causing stock charts to wiggle.'
  ],
  quizzes: [
    {
      id: 'nb1',
