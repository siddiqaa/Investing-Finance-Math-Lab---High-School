...
In this unit, we will explore the algebra of these "Maybe" contracts. We will learn how to build payoff tables that show exactly how much an option is worth when the clock runs out. We will also meet "The Greeks"—Delta, Theta, and Vega—the mathematical tools that professional traders use to navigate this complex world. We are going to learn that while stocks are about the "Price Today," options are about the "Probability of Tomorrow." We'll see how Thales' ancient trick with the olive presses is still used today by the world's biggest hedge funds to protect billions of dollars and make surgical bets on the future. By the end of this lab, you will understand the deep math of inequalities and how to put a price on the unknown.`,
  fullText: [
    '<span className="text-indigo-600 font-bold">The Hook: The Ticket to the Big Game</span>\nImagine you want to go to a massive championship game, but you aren\'t sure if your team will make the finals. You find a broker who sells you a <span className="text-indigo-600 font-bold">Reservation Ticket</span>. This ticket costs \\$10, and it gives you the <span className="italic">right</span> to buy a stadium seat for \\$100 if your team makes it. \n\n- If your team makes the finals and tickets are selling for \\$500, your reservation is amazing! You buy for \\$100 and win big.\n- If your team loses and the stadium is empty, you just throw the \\$10 reservation away. You aren\'t <span className="italic">forced</span> to buy the seat.\n\nThis is exactly how an Option works. It is the price of "Maybe."',
    '1. <span className="text-indigo-600 font-bold">The Insurance Analogy</span>\nAn option is a contract that gives you a right, but not a requirement. \n- A <span className="text-indigo-600 font-bold">Call Option</span> is the right to <span className="italic">buy</span> (you want the price to go UP).\n- A <span className="text-indigo-600 font-bold">Put Option</span> is the right to <span className="italic">sell</span> (you want the price to go DOWN).\n\nThink of a Put Option like Car Insurance. You pay a small fee (premium). If your car (the stock) is fine, you "lose" the fee. but if the car is totaled, the insurance company pays you the full value. You pay for the certainty of a "floor" under your wealth.',
    '2. <span className="text-indigo-600 font-bold">The "Strike" and the "Expiration"</span>\nEvery option has a <span className="text-indigo-600 font-bold">Strike Price</span> (the price you are locked into) and an <span className="text-indigo-600 font-bold">Expiration Date</span> (the deadline).',
    '<span className="text-indigo-600 font-bold">Call Option Payoff Math:</span>\n$\\text{Call Payoff} = \\max(S_T - K, 0)$\n(Where $S_T$ is the final stock price and $K$ is the Strike).',
    'PAYOFF_CALL_TABLE|Stock Price ($S_T$) | Strike ($K$) | Your Payoff\n\\$40 | \\$50 | \\$0 (You walk away)\n\\$50 | \\$50 | \\$0 (At the money)\n\\$60 | \\$50 | \\$10 (In the money!)\n\\$100 | \\$50 | \\$50 (Jackpot)',
    '3. <span className="text-indigo-600 font-bold">Intrinsic Value vs. Time Value</span>\nWhy does an option cost \\$2 even when the stock is below the strike price? Because there is still <span className="text-indigo-600 font-bold">Time</span>. \n- <span className="text-indigo-600 font-bold">Intrinsic Value</span>: The profit you\'d make if you used the option <span className="italic">this second</span>.\n- <span className="text-indigo-600 font-bold">Time Value</span>: The market\'s bet that the stock <span className="italic">might</span> move in your favor before the deadline.',
    '$\\text{Total Price} = \\text{Intrinsic} + \\text{Time Value}$\n\nAs the clock ticks toward the deadline, the "Time Value" evaporates. This is called <span className="text-indigo-600 font-bold">Time Decay</span>. If you buy an option and the stock does nothing, you will lose money every single day just because time is running out.',
    '4. <span className="text-indigo-600 font-bold">The Greeks: The Dashboard of Risk</span>\nProfessional traders don\'t just look at the price; they look at "The Greeks" to see their exposure:',
    '- <span className="text-indigo-600 font-bold">Delta ($\\Delta$)</span>: The Sensitivity. If the stock moves \\$1, how much does the option move? (A Delta of 0.5 means a \\$0.50 move).\n- <span className="text-indigo-600 font-bold">Theta ($\\Theta$)</span>: The Thief. How much value is stolen from you every day by time passing?\n- <span className="text-indigo-600 font-bold">Vega</span>: The Fear. How much does the option price jump if the market gets "scared" and volatility rises?',
    '5. <span className="text-indigo-600 font-bold">Why Options Matter: Leverage & Hedging</span>\n- <span className="text-indigo-600 font-bold">Hedging</span>: Buying a Put to protect a stock you already own.\n- <span className="text-indigo-600 font-bold">Leverage</span>: Buying a Call instead of a stock. For the price of 1 share of Apple, you might be able to buy options that control 100 shares. This can lead to massive wins—or losing 100% of your money in a single day.'
  ],
  quizzes: [
    {
      id: 'o1',
