...
We are going to learn how to stop gambling on single stocks and start building foundations that can survive almost any market weather. We're moving from the chaos of individual jags to the elegance of the "Efficient Frontier," where risk is managed by design, not by luck. By the end of this lab, you will understand that a portfolio is more than just a list of stocks—it is a carefully balanced machine, where the parts are chosen specifically for how they interact with each other. You will learn to see the world not as a collection of separate events, but as a web of correlations that can be mastered.`,
  fullText: [
    '<span className="text-indigo-600 font-bold">The Hook: The Only Free Lunch in Finance</span>\nYou\'ve heard the phrase "don\'t put all your eggs in one basket." But did you know there is a mathematical specific name for why this works? It is called <span className="text-indigo-600 font-bold">Modern Portfolio Theory</span>. In the real world, "risk" and "return" are usually tied together — if you want more money, you have to take more risk. Diversification is the only time in math where you can actually <span className="italic">lower</span> your risk without necessarily giving up your return.',
    '1. <span className="text-indigo-600 font-bold">Portfolio Expected Return: The Weighted Average</span>\nA portfolio is just a collection of different "buckets" of money. To find the total return, we use a <span className="text-indigo-600 font-bold">Weighted Average</span>:\n$E[R_p] = w_1 R_1 + w_2 R_2 + w_3 R_3$\nWhere $w$ is the percentage of your total wealth in that asset.',
    '<span className="text-indigo-600 font-bold">Worked Example — The Balanced Mix:</span>\nYou have \\$10,000. You put \\$5,000 in a Tech Stock (12% return) and \\$5,000 in a safe Bond (4% return).',
    ...
    '2. <span className="text-indigo-600 font-bold">Correlation: The Zig and the Zag</span>\nThe risk of a portfolio isn\'t just the average of the risks. It depends on <span className="text-indigo-600 font-bold">Correlation</span> ($\\rho$): how much assets move together.\n- <span className="text-indigo-600 font-bold">High Correlation (+1.0)</span>: If you own two different oil companies, when oil prices drop, both stocks crash together. You aren\'t diversified; you just have two baskets in the same truck.\n- <span className="text-indigo-600 font-bold">Low Correlation (0 to -1.0)</span>: If you own an Airline (which hates high oil prices) and an Oil Company (which loves them), when one "zigs," the other "zags." This cancels out the drama.',
    '3. <span className="text-indigo-600 font-bold">The Diversification Effect: Lowering the Floor</span>\nWhen you combine assets that aren\'t perfectly correlated, the "swings" of the portfolio become smaller than the swings of the individual stocks. This is the "Free Lunch."',
    '<span className="text-indigo-600 font-bold">Real-World Example:</span>\nImagine two stocks that both return 10% on average, but they are volatile. \n- <span className="text-indigo-600 font-bold">Scenario A</span>: You put all your money in one. You might be up 30% or down 30% next year.\n- <span className="text-indigo-600 font-bold">Scenario B</span>: You split it 50/50 between two stocks that are unrelated. When one crashes 30%, the other happens to be up 10%. Your total move is only -10%. You\'ve "smoothed out" the ride.',
    '4. <span className="text-indigo-600 font-bold">The Sharpe Ratio: Grading Your Risk</span>\nIf you have two portfolios that both returned 10%, but one was a wild roller coaster and the other was a smooth cruise, which is better? The <span className="text-indigo-600 font-bold">Sharpe Ratio</span> tells us. It measures how much "Bonus Return" you got for every unit of "Risk Stress" you took.',
    ...
    '5. <span className="text-indigo-600 font-bold">Beta ($\\beta$): The Market’s Thermometer</span>\nBeta measures how sensitive a stock is to the overall market. \n- <span className="text-indigo-600 font-bold">$\\beta = 1.0$</span>: The stock is the market. If the S&P 500 rises 1%, the stock rises 1%.\n- <span className="text-indigo-600 font-bold">$\\beta = 2.0$</span>: The stock is a "high-beta" stock (like Tesla). It moves twice as fast as the market, up or down.\n- <span className="text-indigo-600 font-bold">$\\beta = 0.5$</span>: The stock is "defensive" (like Walmart or Johnson & Johnson). It only feels half the market\'s swings.',
