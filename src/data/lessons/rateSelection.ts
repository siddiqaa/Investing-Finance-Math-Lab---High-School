...
When you put your money in a savings account, you aren't just "storing" it in a vault like a video game treasure chest. You are actually <span className="text-indigo-600 font-bold">lending</span> your money to the bank! The bank uses your money to make loans to other people (like helping a family buy a house or a local entrepreneur start a pizza shop). In return for letting them use your money, the bank pays you a rent fee. This fee is the interest rate, $r$.
...
In this lesson, we will explore how you choose the "right" $r$ when calculating future goals or making choices between spending today and saving for tomorrow. We will keep things incredibly simple, focusing on the safe interest rates you can actually get from a real bank, without getting lost in the scary jargon of Wall Street risk.`,
  fullText: [
    '<span className="text-indigo-600 font-bold">The Bank as Your Benchmark</span>\nThink of the bank\'s interest rate as your "baseline rate of patience." If you can walk down the street, put your money in a high-yield savings account or a Certificate of Deposit (CD) at a bank, and safely earn a guaranteed <span className="text-indigo-600 font-bold">5%</span> interest per year ($r = 0.05$), then <span className="text-indigo-600 font-bold">5%</span> becomes your ultimate point of comparison. This is what economists call your <span className="text-indigo-600 font-bold">Opportunity Cost</span>.',
    '1. <span className="text-indigo-600 font-bold">The Opportunity Cost Test</span>\nSuppose a friend asks to borrow \\$100 today and promises to pay you back \\$103 in one year. Your friend says, "That\'s a great deal! You get \\$3 of free profit!"\n\nIs it actually a good deal? Let\'s use our bank benchmark ($r = 5\\%$) to find out:\n\nIf you put that \\$100 in the bank at $5\\%$, in one year you will have:\n$FV = \\$100 \\times (1 + 0.05)^1 = \\$105$\n\nBy lending the money to your friend, you are <span className="italic">giving up</span> the opportunity to earn $5\\%$ at the bank. Because the bank would have given you \\$105, your friend\'s promise of \\$103 is actually a bad deal. You are mathematically losing \\$2 of potential wealth! The bank\'s rate $r$ is the barrier that any other opportunity has to beat.',
    '2. <span className="text-indigo-600 font-bold">Savings Accounts vs. Certificates of Deposit (CDs)</span>\nWhen you go to a bank, they will offer different rates ($r$) depending on how long you promise to leave your money untouched:\n\n- <span className="text-indigo-600 font-bold">High-Yield Savings Accounts:</span> These let you withdraw your money whenever you want (highly flexible). Because of this flexibility, they might pay a slightly lower rate, like <span className="text-indigo-600 font-bold">3% to 4%</span>.\n- <span className="text-indigo-600 font-bold">Certificates of Deposit (CDs):</span> A CD is a lock-box agreement. You promise the bank, "I will not touch this money for 1 year (or 2 years, or 5 years)." Because you are selling them your guaranteed patience, the bank will reward you with a higher rate, such as <span className="text-indigo-600 font-bold">5%</span> ($r = 0.05$).',
    '3. <span className="text-indigo-600 font-bold">Choosing the Right "r" for Your Goals</span>\nWhen you are doing calculations for your own life, how do you decide which rate $r$ to type into your formula?\n\n- <span className="text-indigo-600 font-bold">If you are planning a short-term goal (under 1 year):</span> Use a standard high-yield savings account rate (e.g., $r = 3.5\\%$).\n- <span className="text-indigo-600 font-bold">If you are planning a medium-term goal (2 to 5 years):</span> Use a Certificate of Deposit rate (e.g., $r = 4.5\\%$ or $5\\%$) because you can lock your money in safely for that duration.',
    '<span className="text-indigo-600 font-bold">Summary Check — The Three Golden Rules of the Rate r:</span>\n- <span className="text-indigo-600 font-bold">Rule 1:</span> The rate $r$ is the price of patience.\n- <span className="text-indigo-600 font-bold">Rule 2:</span> Always compare any investment to the safe rate you can get at a local bank.\n- <span className="text-indigo-600 font-bold">Rule 3:</span> If an option doesn\'t pay <span className="italic">more</span> than the bank rate, let the bank keep your money instead!'
  ],
  quizzes: [
    {
      id: 'r1',
      ...
      options: [
        ...
        '\\$50, because that is the safe interest you <span className="italic">could</span> have earned if you gave it to the bank',
