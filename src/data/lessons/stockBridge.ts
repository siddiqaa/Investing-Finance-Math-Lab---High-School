...
export const stockBridge: LessonContent = {
  ...
  introduction: `In Unit 2, we looked at how bank rates (like High-Yield Savings Accounts and CDs) provide a secure benchmark of around $3\\%$ to $5\\%$. That is a great way to protect your money. But what if you want to grow your wealth over the long term to buy a house, fund college, or build real financial independence?

To outpace the steady grind of inflation and grow your money faster, you have to transition from being a <span className="text-indigo-600 font-bold">lender</span> (depositing cash in a bank) to an <span className="text-indigo-600 font-bold">owner</span>. This is where <span className="text-indigo-600 font-bold">stocks</span> come in.

A stock is not a dynamic ticket for a casino game or a line on a flashing green screen. A stock is <span className="text-indigo-600 font-bold">fractional ownership</span> of a real business—like Apple, Nike, or Spotify. In this unit, we will learn why businesses can return more than a bank, and how a small difference in the interest rate $r$ leads to breathtaking gaps in wealth over time. This lays the perfect foundation before we learn how to calculate what a stock is actually worth.`,
  fullText: [
    '<span className="text-indigo-600 font-bold">1. Stocks as Fractional Ownership</span>\nWhen you buy a single share of a company, you are purchasing a tiny, legal slice of that company\'s assets and future profits. If a company has 1 million total shares, and you buy 1 share, you own exactly $1 / 1{,}000{,}000$ of that entire business!\n\nBecause you are an owner, if the business sells more products, increases its profits, or invents the next big technology, the value of your tiny slice grows. This is why stocks are called <span className="text-indigo-600 font-bold">equity</span>—they represent actual, tangible value in productive enterprises.',
    '2. <span className="text-indigo-600 font-bold">Why Businesses Can Return More Than Banks</span>\nWhy does a stock index historically return about <span className="text-indigo-600 font-bold">8% to 10%</span> per year, while a bank CD might only pay <span className="text-indigo-600 font-bold">4.5%</span>?\n\nIt comes down to productive work. A bank is a middleman: they take your money, pay you a low interest rate, and then turn around to lend that money to businesses at a higher rate. Businesses take those loans (and your investment cash) to hire smart engineers, build factories, ship products, and make sales. Because businesses are actively creating new value and solving problems, their rate of growth ($r_{\\text{stock}}$) is naturally designed to outpace the simple passive rent fee paid by a bank ($r_{\\text{bank}}$).',
    '3. <span className="text-indigo-600 font-bold">The Power of the Rate Spread (r_stock vs. r_bank)</span>\nEven a seemingly small difference in your rate—like earning <span className="text-indigo-600 font-bold">9%</span> in stocks instead of <span className="text-indigo-600 font-bold">4%</span> in a savings account—results in mind-boggling differences when compounded over decades. This is the <span className="text-indigo-600 font-bold">Growth Spread</span>.\n\nLet\'s compare investing \\$1,000 at a bank rate of $4\\%$ versus a stock index averaging $9\\%$ over 30 years:\n\n- <span className="text-indigo-600 font-bold">Bank Savings Account ($r = 4\\%$):</span>\n$FV_{\\text{bank}} = \\$1{,}000 \\times (1 + 0.04)^{30} \\approx \\$3{,}243$\n\n- <span className="text-indigo-600 font-bold">Stock Market Investment ($r = 9\\%$):</span>\n$FV_{\\text{stock}} = \\$1{,}000 \\times (1 + 0.09)^{30} \\approx \\$13{,}268$\n\nBy choosing ownership over safe lending, your wealth grew to be <span className="text-indigo-600 font-bold">over four times larger</span>! Over a long timeline, the stock market\'s higher compounding rate is the ultimate weapon to grow your savings.',
    '<span className="text-indigo-600 font-bold">Summary Check — Transitioning Your Mindset:</span>\n- <span className="text-indigo-600 font-bold">Banks</span> are excellent for safe, short-term goals because they guarantee your principal.\n- <span className="text-indigo-600 font-bold">Stocks</span> are designed for long-term compounding because they let you participate directly in the profits of growing businesses.\n- <span className="text-indigo-600 font-bold">The Rule of Ownership:</span> In the long run, owners who take calculated business risks make far more than lenders who seek complete safety.'
  ],
  quizzes: [
    {
      id: 'sb1',
